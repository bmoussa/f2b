...
// do something before closing the process
// after receiving the signal SIGILL (signal to close)
void my_handler(int signal){
	printf("returned %d\n", signal);
	
	// comment the following line to ignore the kill process
	exit(EXIT_SUCCESS);
}
...
int main() {
	...
	// redirect handler of signal SIGILL to my_handler

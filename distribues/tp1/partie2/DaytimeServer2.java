...
/**/        System.out.println("A client has made connection.");
			...
			// stopping thread for 3 seconds before answering client
			// if another client create a request at same time, 
			// the server executes it after finishing the first answer
			Thread.sleep(3000);
